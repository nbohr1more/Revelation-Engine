...
*/
template< class type >
ID_INLINE idHierarchy<type>::idHierarchy() {
	owner = NULL;
	parent = NULL;
	sibling = NULL;
	child = NULL;
...
*/
template< class type >
ID_INLINE type *idHierarchy<type>::Owner(void) const {
	return owner;
}
...
*/
template< class type >
ID_INLINE void idHierarchy<type>::SetOwner(type *object) {
	owner = object;
}
...
*/
template< class type >
ID_INLINE bool idHierarchy<type>::ParentedBy(const idHierarchy &node) const {
	if (parent == &node) {
		return true;
	}
	else if (parent) {
...
*/
template< class type >
ID_INLINE void idHierarchy<type>::ParentTo(idHierarchy &node) {
	RemoveFromParent();
	parent = &node;
	sibling = node.child;
	node.child = this;
...
*/
template< class type >
ID_INLINE void idHierarchy<type>::MakeSiblingAfter(idHierarchy &node) {
	RemoveFromParent();
	parent = node.parent;
...
*/
template< class type >
ID_INLINE void idHierarchy<type>::RemoveFromParent(void) {
...
*/
template< class type >
ID_INLINE void idHierarchy<type>::RemoveFromHierarchy(void) {
...
*/
template< class type >
ID_INLINE type *idHierarchy<type>::GetParent(void) const {
	if (parent) {
		return parent->owner;
	}
	return NULL;
...
*/
template< class type >
ID_INLINE type *idHierarchy<type>::GetChild(void) const {
	if (child) {
		return child->owner;
	}
	return NULL;
...
*/
template< class type >
ID_INLINE type *idHierarchy<type>::GetSibling(void) const {
	if (sibling) {
...
*/
template< class type >
ID_INLINE idHierarchy<type> *idHierarchy<type>::GetPriorSiblingNode(void) const {
...
*/
template< class type >
ID_INLINE type *idHierarchy<type>::GetPriorSibling(void) const {
...
*/
template< class type >
ID_INLINE type *idHierarchy<type>::GetNext(void) const {
...
*/
template< class type >
ID_INLINE type *idHierarchy<type>::GetNextLeaf(void) const {
	const idHierarchy<type> *node;
	if (child) {
		node = child;
		while (node->child) {
