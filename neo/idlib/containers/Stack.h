...
template< class type, int nextOffset >
ID_INLINE idStackTemplate<type, nextOffset>::idStackTemplate(void) {
	top = bottom = NULL;
}

template< class type, int nextOffset >
ID_INLINE void idStackTemplate<type, nextOffset>::Add(type *element) {
...
template< class type, int nextOffset >
ID_INLINE type *idStackTemplate<type, nextOffset>::Get(void) {
	type *element;
	element = top;
	if (element) {
