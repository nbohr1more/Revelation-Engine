...
template< class type, int nextOffset >
ID_INLINE idQueueTemplate<type, nextOffset>::idQueueTemplate(void) {
	first = last = NULL;
}

template< class type, int nextOffset >
ID_INLINE void idQueueTemplate<type, nextOffset>::Add(type *element) {
...
template< class type, int nextOffset >
ID_INLINE type *idQueueTemplate<type, nextOffset>::Get(void) {
	type *element;
	element = first;
	if (element) {
