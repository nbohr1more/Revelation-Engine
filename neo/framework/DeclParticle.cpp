...
==================
*/
int	idParticleStage::ParticleVerts(particleGen_t *g, const idVec3 &origin, idDrawVert *verts) const {
...
void idParticleStage::ParticleColors(particleGen_t *g, idDrawVert *verts) const {
	...
	for (int i = 0; i < 4; i++) {
		...
		verts[0].color[i] = icolor;
		verts[1].color[i] = icolor;
		verts[2].color[i] = icolor;
