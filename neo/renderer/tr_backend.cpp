...
void RB_SetDefaultGLState(void) {
	...
	// the vertex and texture coordinate arrays are always enabled
...
Copy part of the current depthbuffer to an image
=============
*/
const void	RB_CopyDepth(const void *data) {
	...
	if (cmd->image) {
		cmd->image->CopyDepthbuffer(cmd->x, cmd->y, cmd->imageWidth, cmd->imageHeight, false);
	}
}
