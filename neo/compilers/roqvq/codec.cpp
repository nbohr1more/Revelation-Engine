...
void codec::VQ(const int numEntries, const int dimension, const unsigned char *vectors, float *import, VQDATA **codebook, const bool optimize) {
	...
	bool *inuse = (bool *)_alloca8(numEntries * sizeof(bool));
	float *snrs = (float *)_alloca8(numEntries * sizeof(float));
	int *indexes = (int *)_alloca8(numEntries * sizeof(int));
	int *indexet = (int *)_alloca8(numEntries * sizeof(int));
